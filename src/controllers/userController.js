            ...
            if (users && users.length >= 1) {
                ...
                bcrypt.hash(params.password, null, null, (err, hash) => {
                    ...
                    user.save((err, userStored) => {
                        ...
                        if (userStored) {
                            res.status(200).send({ identityDATABack:userStored, message:"Registrado correctamente", token: jwt.createToken(userStored) })
                        } else {
...
function verificarEmail(req, res) {
    ...
    const mailOptions = {
        ...
        html: `
        <html style="width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;"><head> 
        <meta charset="UTF-8"> 
                       ...
                       <tbody><tr style="border-collapse:collapse;"> 
                        <td width="560" valign="top" align="center" style="padding:0;Margin:0;"> 
                         <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left top;" width="100%" cellspacing="0" cellpadding="0"> 
                           <tbody><tr style="border-collapse:collapse;"> 
                            <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;"> <img src="https://images-expokinal2019.s3.amazonaws.com/escudo.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="175"></td> 
                           </tr> 
                           <tr style="border-collapse:collapse;"> 
                           ...
                           <tr><td align="center" style="padding:0;Margin:0;padding-top:25px;padding-left:40px;padding-right:40px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;"><font style="vertical-align:inherit;"><font style="vertical-align:inherit;"><font style="vertical-align:inherit;"><font style="vertical-align:inherit;">(No comparta el código con nadie).</font></font></font></font></p> </td> 
                           </tr>
                           <tr style="border-collapse:collapse;"> 
...
`
    ...
    transporter.sendMail(mailOptions, function (err, info) {
        ...
        res.status(404).send({ message: 'Ingrese un correo valido' });

        }else
            console.log(info);
            res.status(200).send({ message: 'Revise su bandeja de correo por favor, en caso de no encontrarlo, revise "SPAM"' });
    });
